...
let didacTexts = [
    "There are also keys. Shiny, golden. If you find one, you can open a door.",
    "They can lead you to the exit, to the next step... or into a trap. It all depends on you.",
];
...
if (didacStep === 22) {
    ...
    }, 3500); // petit délai pour le dramatique
}
}
...
function moveBoth(dxLeft, dyLeft) {
    ...
    if (map[newLeftY][newLeftX] === 'W' || map[newRightY][newRightX] === 'W') {
        window.location.href = 'didacticielquatre.php';
        return;
    }

    if (map[newLeftY][newLeftX] === 'M' || map[newRightY][newRightX] === 'M') {
        window.location.href = 'didacticielcinq.php';
        return;
    }
