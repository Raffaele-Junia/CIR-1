...
let chibiImages = [
    ...
    '../pictures/didacticiel/chibicontent.png',
...
let chibiImagesdeux = [
    ...
    '../pictures/didacticiel/rine.png',
    '../pictures/didacticiel/chibiraff/pascomprisraff.png',
    '../pictures/didacticiel/chibiraff/endormiraffy.png',
...
let didacTexts = [
    "Well done to you, but this is only the beginning of a long story.",
    "So I have to avoid the Void, use the barrels, look for the keys, open the doors, reach the exit ?",
    "But why make me go through all this ?!",
    "Why? Because the people up there want to play with you.",
    "Why me? For what purpose ?",
    "...",
    "I don't know..",
    "Okay now I've talked enough with you...",
    "????????????",
];
